    ...
    <div>
      <Table bordered hover>
        <thead style={{border:'2px solid black'}}>
          <tr>
            <th style={{ width: "60%", verticalAlign:'middle' }}>Subject Code & Name</th>
            <th style={{ textAlign: "center", padding: 0, width: "12%", border:'2px solid black' }}>
        ...
        <tbody style={{border:'2px solid black'}}>
          <tr>
            <td style={{ width: "60%",border:'2px solid black',padding:'0px 8px' }}>Operating System BCST-501</td>
            <td style={{ textAlign: "center", width: "12%",border:'2px solid black',padding:0 }}>
              <tr style={{ display: "flex" }}>
